                    ...
                    <section className='grid lg:grid-cols-3 pt-2 pb-12 grid-cols-1 lg:gap-x-5 gap-y-7'>
                        ...
                        <div className='lg:order-none order-last col-span-2 rounded-md lg:h-[27rem] mx-auto w-full lg:max-w-none sm:max-w-[30rem] max-w-[26rem] bg-gray-100'>
                            <iframe
                                ...
                                // src={`https://www.google.com/maps?q=${delivery.customer_location.toLowerCase()}/${delivery.restaurant_location.toLowerCase()}&output=embed`}
                                src={`https://www.google.com/maps/embed/v1/directions?key=AIzaSyC-vN8Ab_-kpTG5uhxg72UNN3e9fG2qPFE&origin=${delivery.restaurant_location.toLowerCase()}&destination=${delivery.customer_location.toLowerCase()}`}
